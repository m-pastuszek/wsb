  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="../scripts/add_user.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" placeholder="Powtórz adres e-mail" name="email_confirmation">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Powtórz hasło" name="password_confirmation">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <!-- Miasta TODO: Pobrać z bazy danych -->
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Miasto" name="city" value="1">
          <div class="input-group-append">
            <div class="input-group-text">
